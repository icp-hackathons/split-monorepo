...
interface IVRC25Interface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "Fee(address,address,address,uint256)": EventFragment;
...
export class IVRC25 extends BaseContract {
  ...
  functions: {
    ...
    estimateFee(value: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    Fee(
      ...
      { from: string; to: string; issuer: string; value: BigNumber }
    >;
  ...
  populateTransaction: {
    ...
    estimateFee(value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
