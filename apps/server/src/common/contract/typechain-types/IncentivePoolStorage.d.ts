...
interface IncentivePoolStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class IncentivePoolStorage extends BaseContract {
  ...
  interface: IncentivePoolStorageInterface;
