...
interface IncentivePoolFactoryInterfaceInterface extends ethers.utils.Interface {
  functions: {};
...
export class IncentivePoolFactoryInterface extends BaseContract {
  ...
  interface: IncentivePoolFactoryInterfaceInterface;
