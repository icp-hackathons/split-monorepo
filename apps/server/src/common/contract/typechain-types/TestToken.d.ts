...
interface TestTokenInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "mintFor", values: [string, BigNumberish]): string;
...
export class TestToken extends BaseContract {
  ...
  callStatic: {
    ...
    mintFor(for_: string, amount_: BigNumberish, overrides?: CallOverrides): Promise<void>;
